                ...
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="d-flex justify-content-center">
                                <div class="auth-header">
                                    <h2 class="text-secondary mt-5"><b>Edit Profile</b></h2>
                        ...
                        <form method="POST" action="{{ route('profile.update') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-validate" id="first_name" name="first_name"
                                    placeholder="First name" value="{{ old('first_name', $user->first_name) }}" required maxlength="50"/>
                                @error('first_name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-validate" id="middle_name" name="middle_name"
                                    placeholder="Middle name" value="{{ old('middle_name', $user->middle_name) }}" maxlength="25"/>
                                @error('middle_name')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-validate" id="last_name" name="last_name"
                                    placeholder="Last name" value="{{ old('last_name', $user->last_name) }}" required maxlength="50"/>
                                @error('last_name')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control @error('user_mobile') is-invalid @enderror"
                                    ...
                                    value="{{ old('user_mobile', $user->user_mobile) }}" required>
                                @error('user_mobile')
                                ...
                                <input type="hidden" name="mobile_country_code" id="mobile-country-code"
                                    value="{{ old('mobile_country_code', $user->mobile_country_code) ?? '91' }}" />
                                <input type="hidden" name="mobile_country_iso_code" id="mobile-country-iso-code"
                                    class="@error('user_mobile') is-invalid @enderror"
                                    value="{{ old('mobile_country_iso_code', $user->mobile_country_iso_code) ?? 'in' }}" />
                            </div>
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Confirm Password" maxlength="8" />
                            ...
                            <div class="d-grid mt-4">
                                <button type="submit" class="btn btn-secondary p-2">Update Profile</button>
                            </div>
                        </form>
                        <hr />
                        ...
                        <div class="d-flex mt-1 justify-content-between">
                            ...
                            <h5 class="d-flex justify-content-center">Want to change your password?</h5>
    ...
    <script>
        ...
        $('#password_confirmation').on('change', function() {
            ...
            if (password !== passwordConfirmation) {
                ...
                if (togglePasswordIcon) togglePasswordIcon.querySelector('i').classList.remove('fa-eye');
            } else {
                $('#password_confirmation_error').text('');
                $(this).removeClass('is-invalid');
                if (togglePasswordIcon) togglePasswordIcon.querySelector('i').classList.add('fa-eye');
            }
        });
