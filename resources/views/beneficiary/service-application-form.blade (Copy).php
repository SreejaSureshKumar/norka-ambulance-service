            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-control-validate" id="contact_abroad_name"
                        name="contact_abroad_name" placeholder="Enter Abroad contact name" value="{{ old('contact_abroad_name') }}" maxlength="30">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-control-validate" id="contact_local_name"
                        name="contact_local_name" placeholder="Enter local contact name" value="{{ old('contact_local_name')  }}" maxlength="30" required>
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control form-control-validate" id="native_address" name="native_address" rows="2"
                        placeholder="Enter communication address" required></textarea>
