            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="section-block">
                        ...
                        <div class="bq-note-item" style="background: #f8f9fa; border-radius: 8px; padding: 1rem 1.25rem; box-shadow: 0 1px 4px rgba(0,0,0,0.04);">
                           
                            <div class="bq-note-text rich-formatted-text-container" style="font-size: 1.08rem; color: #212529;">
                                {{ $application->remarks }}
                            </div>
                            <div class="bq-note-meta mb-2" style="font-size: 0.97rem; color: #6c757d;">
                                ...
                                <span class="bq-note-by">By <span>{{ $application->processedUser->name ?? 'N/A' }}</span></span>
                            @endif
                            </div>
                        </div>
                    </div>
