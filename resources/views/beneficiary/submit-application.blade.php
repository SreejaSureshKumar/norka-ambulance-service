        ...
        <div class="row justify-content-center">
            <div class="col-lg-9 col-md-11">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-secondary-dark text-white text-center">
                        <h4 class="mb-1 text-white"> Application Form</h4>
                    </div>
                    <div class="card-body py-4">
                        <form method="POST" action="{{ route('beneficiary.submit-application') }}" class="needs-validation"
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-secondary btn-lg w-100">Submit Application</button>
                            </div>
                        </form>
                    </div>
                </div>
