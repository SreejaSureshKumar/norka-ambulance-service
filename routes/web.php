...
Route::middleware(['auth', 'NoCache'])->group(function () {
    ...
    Route::get('/application-form', [App\Http\Controllers\BeneficiaryController::class, 'applicationForm'])->name('beneficiary.application-form');
    Route::post('/submit-application', [App\Http\Controllers\BeneficiaryController::class, 'submitApplication'])->name('beneficiary.submit-application'); 
    Route::get('/application-list', [App\Http\Controllers\BeneficiaryController::class, 'listApplication'])->name('beneficiary.application-list');
